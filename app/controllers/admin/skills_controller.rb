class Admin::SkillsController < ApplicationController
  ...
  def create
    ...
    @type_skill = TypeSkill.find(skill_params[:type_skill_id])
    puts "habilidad encontrado #{@type_skill}"

    @skill = Skill.new(skill_params)
    @skill.type_skill_id = @type_skill.id
  ...
  private
    ...
    def skill_params
      params.require(:skill).permit(:name, :type_skill_id)
    end
end
